...
globalkeys = my_table.join(
    ...
    awful.key({ altkey }, "space", function () awful.util.spawn("/home/marhearn/.config/rofi/launchers/colorful/launcher.sh") end,
        {description = "rofi" , group = "hotkeys" }),

    -- My applications
    awful.key({ modkey }, "e", function () awful.util.spawn("codium") end,
        {description = "codium" , group = "applications" }),
    ...
    -- Standard program
    awful.key({ modkey,           }, "grave", function () awful.spawn( terminal ) end,
