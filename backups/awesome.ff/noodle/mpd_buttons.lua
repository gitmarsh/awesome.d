...
mpd_toggle_icon:buttons(gears.table.join(
    awful.button({ }, 1, function ()
        awful.spawn.with_shell("playerctl -p ncspot -s play-pause")
    end),
...
mpd_prev_icon:buttons(gears.table.join(
    awful.button({ }, 1, function ()
        awful.spawn.with_shell("playerctl -p ncspot previous")
    end),
    awful.button({ }, 3, function ()
        awful.spawn.with_shell("playerctl -p ncspot previous")
    end)
...
mpd_next_icon:buttons(gears.table.join(
    awful.button({ }, 1, function ()
        awful.spawn.with_shell("playerctl -p ncspot next")
    end),
    awful.button({ }, 3, function ()
        awful.spawn.with_shell("playerctl -p ncspot next")
    end)
