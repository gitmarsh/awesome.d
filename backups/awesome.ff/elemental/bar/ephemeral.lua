...
local volume_unmuted_color = x.color2
...
local music = create_button("", x.color9, x.color8.."90", x.color8.."B0")
...
--[[local binclock = require("evil.binclock"){
--    height = dpi(32),
-    show_seconds = true,
    color_active = x.color2,
    color_inactive = x.color1
}]]--
-- mybinclock = binclock()
...
local binclock = require("evil.binclock"){
    ...
    s.mywibox:setup {
        ...
        wibox.container.margin(binclock.widget, dpi(2), dpi(4)),
        s.mytasklist,
