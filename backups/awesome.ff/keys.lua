...
local susbrowser = "google-chrome-stable"
...
keys.globalkeys = gears.table.join(
    ...
    -- Focus Next Screen
    awful.key({ superkey }, "Tab", function () awful.screen.focus_relative( 1) end,
    	{description = "change focus of screen", group = "client"}),
    ...
    -- Web search
    awful.key({ superkey,           }, "g", function () mymainmenu:show() end,
    ...
    -- Dashboard
    awful.key({ superkey }, "Return", function() dashboard_show() end,
        -- rofi_show()
{description = "dashboard", group = "custom"}),
    ...
    -- Spawn file manager
    awful.key({ superkey, altkey }, "e", apps.file_manager,
        {description = "file manager", group = "launcher"}),
    -- Spawn music client
    awful.key({ superkey, altkey }, "m", apps.music,
    ...
    -- Sound Settings
    awful.key({ superkey, altkey}, "p", function ()
    ...
    awful.key({ superkey, altkey}, "w", function ()
	awful.spawn(susbrowser) end,
	{description = "run susbrowser", group = "client"}
	),
...
keys.clientkeys = gears.table.join(
    ...
    awful.key({ altkey, ctrlkey }, "Tab",      function (c) c:move_to_screen()
        end,
        {description = "move to screen", group = "client"})
)
