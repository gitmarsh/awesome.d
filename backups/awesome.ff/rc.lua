...
user = {
   ...
   -- web_search_cmd = "xdg-open https://duckduckgo.com/?q=",
    ...
    openweathermap_key = "dc6c39a5fab38b96398f0b10c41d9cc3",
    openweathermap_city_id = "4671654",
    ...
    coronavirus_country = "united states",
}
-- ===================================================================
-- Load the module
...
awful.spawn.once("xrandr --output DVI-D-0 --off --output HDMI-0 --mode 1920x1080 --pos 0x0 --rotate normal --output DP-0 --primary --mode 2560x1440 --pos 1920x0 --rotate normal --output DP-1 --off")
