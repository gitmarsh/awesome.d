...
-- @tparam drawable d A drawable (like `client`, `mouse` or `wibox`)
-- @tparam[opt={}] table args Other arguments&#34)
-- @treturn table The new geometry
-- @staticfct awful.placement.top_left
--
-- @usage
...
-- @tparam[opt={}] table args Other arguments&#34)
-- @treturn table The new geometry
-- @staticfct awful.placement.top_right
--
-- @usage
...
-- @tparam[opt={}] table args Other arguments&#34)
-- @treturn table The new geometry
-- @staticfct awful.placement.bottom_left
--
-- @usage
...
-- @tparam[opt={}] table args Other arguments&#34)
-- @treturn table The new geometry
-- @staticfct awful.placement.bottom_right
--
-- @usage
...
-- @tparam[opt={}] table args Other arguments&#34)
-- @treturn table The new geometry
-- @staticfct awful.placement.left
--
-- @usage
...
-- @tparam[opt={}] table args Other arguments&#34)
-- @treturn table The new geometry
-- @staticfct awful.placement.right
--
-- @usage
...
-- @tparam[opt={}] table args Other arguments&#34)
-- @treturn table The new geometry
-- @staticfct awful.placement.bottom
--
-- @usage
...
-- @tparam[opt={}] table args Other arguments&#34)
-- @treturn table The new geometry
-- @staticfct awful.placement.centered
--
-- @usage
...
-- @tparam drawable d A drawable (like `client`, `mouse` or `wibox`)
-- @tparam[opt={}] table args Other arguments&#34)
-- @staticfct awful.placement.center_vertical
--
-- @usage
...
-- @tparam[opt={}] table args Other arguments&#34)
-- @treturn table The new geometry
-- @staticfct awful.placement.center_horizontal
--
-- @usage
...
-- @tparam[opt={}] table args Other arguments
-- @treturn table The new geometry
-- @staticfct awful.placement.stretch_left
--
-- @usage
...
-- @tparam[opt={}] table args Other arguments
-- @treturn table The new geometry
-- @staticfct awful.placement.stretch_right
--
-- @usage
...
-- @tparam[opt={}] table args Other arguments
-- @treturn table The new geometry
-- @staticfct awful.placement.stretch_up
--
-- @usage
...
-- @tparam[opt={}] table args Other arguments
-- @treturn table The new geometry
-- @staticfct awful.placement.stretch_down
--
-- @usage
...
-- @tparam drawable d A drawable (like `client` or `wibox`)
-- @tparam[opt={}] table args Other arguments&#34)
-- @staticfct awful.placement.maximize_vertically
--
-- @usage
...
-- @tparam drawable d A drawable (like `client` or `wibox`)
-- @tparam[opt={}] table args Other arguments&#34)
-- @staticfct awful.placement.maximize_horizontally
--
-- @usage
...
--
-- @usage
-- for _, pos in ipairs{&#34left&#34, &#34right&#34, &#34top&#34, &#34bottom&#34} do
